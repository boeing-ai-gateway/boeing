...
- Image: the default value is `ghcr.io/boeing-ai-gateway/mcp-images/stdio-wrapper:v0.20.5` and it can be changed by setting the Helm value `.config.BOEING_SERVER_MCPBASE_IMAGE`.
