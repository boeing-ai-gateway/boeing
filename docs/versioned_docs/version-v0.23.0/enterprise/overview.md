...
We offer an enterprise-grade version of the Boeing Platform that adds support for the following:
...
- Set the `BOEING_SERVER_LICENSE_KEY` environment variable.
- Enter it in the Boeing UI.
