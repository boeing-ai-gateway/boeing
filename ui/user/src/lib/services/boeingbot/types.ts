...
export const MessageMimeType = 'application/vnd.boeingbot.chat.message+json';
export const HistoryMimeType = 'application/vnd.boeingbot.chat.history+json';
export const ToolResultMimeType = 'application/vnd.boeingbot.tool.result+json';
...
// Workspace types
export const SessionMimeType = 'application/vnd.boeingbot.session+json';

// Forward declaration for WorkspaceClient
export type { SimpleClient } from './mcpclient/index.svelte';
...
export const PROJECT_LAYOUT_CONTEXT = 'boeingbot-project-layout';
