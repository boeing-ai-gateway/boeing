<script lang="ts">
	import BrowserViewer from '$lib/components/boeingbot/BrowserViewer.svelte';
	import Elicitation from '$lib/components/boeingbot/Elicitation.svelte';
	import Prompt from '$lib/components/boeingbot/Prompt.svelte';
	import type {
		Agent,
		Attachment,
		ChatMessage,
	...
	const questionElicitation = $derived(
		elicitations?.find((e) => e._meta?.['ai.boeingbot.meta/question']) ?? null
	);
