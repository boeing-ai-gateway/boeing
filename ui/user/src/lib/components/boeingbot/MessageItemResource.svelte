<script lang="ts">
	import { getFileIcon } from '$lib/components/boeingbot/MessageAttachments.svelte';
	import { formatFileSize } from '$lib/format';
	import type { ChatMessageItemResource } from '$lib/services/boeingbot/types';
	import { isCancellationError } from '$lib/services/boeingbot/utils';
	...
	let isError = $derived(item.resource.mimeType === 'application/vnd.boeingbot.error+json');
