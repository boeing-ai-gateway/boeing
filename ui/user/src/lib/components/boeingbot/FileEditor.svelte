<script lang="ts">
	...
	import type { ResourceContents } from '$lib/services/boeingbot/types';
	...
	function getResourcePath(filename: string): string {
		...
		const homePrefix = '/home/boeingbot/';
	...
	$effect(() => {
		...
		const loadResource = async () => {
			...
			try {
				...
				const result = await $boeingbotChat.api.readResource(resourcePath);
